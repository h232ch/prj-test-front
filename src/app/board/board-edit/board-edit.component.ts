...
export class BoardEditComponent implements OnInit, OnDestroy {
    ...
    private boardObs: Observable<BoardTemp>;
    ...
    ngOnInit(): void {
        this.boardService.error
            ...
            .subscribe(res => {
                this.error = this.formatError(res);
            });
    ...
    onChangeBoard(boardData, user: User): BoardTemp {
        if (this.editMode) {
            return {
                id: undefined, // server will provide the ID
                user: undefined,
                email: undefined,
